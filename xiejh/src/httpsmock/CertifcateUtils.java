...
public class CertifcateUtils {
	...
	public static byte[] readPrivateKey() throws  Exception{
        ...
        InputStream in=new FileInputStream("C:/Users/Administrator/https.keystore");
        store.load(in,"xiejh1".toCharArray());
        PrivateKey pk=(PrivateKey)store.getKey("xiejh1","xiejh1".toCharArray());
